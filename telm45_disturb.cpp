...
rflog1 << "final equilibration year = " << year <<  " " << tem.getNEP() << endl;
...
//        cout << "SMOIST in telm = " << dm << " " << tempred.mon[dm] << endl;
      }
    }
...
//  cout << "qc, tqc = " << cohort[pichrt].qc << " " << cohort[pichrt].tqc << endl;
  if( ACCEPT == cohort[pichrt].qc
...
//    cout << "NDEP in telm = " << tem.atms.getNDEP() << endl;
...
//    cout << "CO2 = " << pdm << " " << pdyr << " " << tem.atms.getCO2() << endl;
