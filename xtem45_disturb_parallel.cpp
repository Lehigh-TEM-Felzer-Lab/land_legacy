...
//cout << "show = " << telmnt[0].col << " " << telmnt[0].row << " " << telmnt[0].tem.totyr << " " << telmnt[0].tem.inittol << " " << telmnt[0].tem.veg.getERRCNT() << endl;
...
void updateTCLMGridCell( const int& pdyr )
{
  ...
  if( 0 == pdyr )
  {
    ...
    {
//   BSF CO2 fix to read one additional value (i.e. transtime + 1)
...
cout << "ndepdat = " <<  ndepdat[0].col <<  " " << ndepdat[0].row << " " << ndepdat[0].adepval << endl;
  }
...
//    else
//    {
//     telmnt[0].adep[0][pdyr]= ndepdat[0].adepval;
//    }
...
cout << "cohort = " << telmnt[0].tem.veg.cmnt << " " << telmnt[0].cohort[ichrt].agcmnt << " " << pdyr << " " << ichrt << " " << telmnt[0].maxcohorts  << endl;
